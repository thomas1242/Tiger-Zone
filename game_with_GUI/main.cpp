...
int main() {
    ...
    while (window.isOpen())
    {
        ...
        string player1score = "player 1's score: " + int2Str( 0 );
        ...
        string player2score = "player 2's score: " + int2Str( 0 );
        text5.setString(player2score);
        window.draw(text5); //p2 sc
        
        string player1meeps = "player 1's tigers: " + int2Str(game->getMeeples( true ));
        text4b.setString(player1meeps);
        window.draw(text4b); //p1 sc
        
        
        string player2meeps = "player 2's tigers: " + int2Str(game->getMeeples( false ));
